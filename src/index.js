...
export async function onPostBuild({
  ...
  if (process.env.PRINCE_LICENSE) {
    ...
    ;(text =
      "Prince license not found, please set the 'PRINCE_LICENSE' environment variable to remove the watermark."),
  ...
  await Prince()
    ...
    .then(
      function () {
        status.show({
          summary: `PDF generated successfully to ${PUBLISH_DIR}/${inputs.fileName}`,
          text: text,
        })
      },
      function (error) {
